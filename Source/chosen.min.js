...
a),this.search_field.set("tabindex",-1)))},show_search_field_default:function(){this.is_multiple&&this.choices<1&&!this.active_field?(this.search_field.set("value",this.default_text),this.search_field.addClass("default")):(this.search_field.set("value",""),this.search_field.removeClass("default"))},search_results_click:function(a){if(a=a.target.hasClass("active-result")?a.target:a.target.getParent(".active-result"))this.result_highlight=a,this.result_select()},search_results_mouseover:function(a){(a=
...
this.choices>0&&this.search_field.value.length<1&&this.results_hide();this.result_deselect(a.get("rel"));a.getParent("li").destroy()},result_select:function(){var a,b;if(this.result_highlight)a=this.result_highlight,b=a.get("id"),this.result_clear_highlight(),a.addClass("result-selected"),this.is_multiple?this.result_deactivate(a):this.result_single_selected=a,a=b.substr(b.lastIndexOf("_")+1),a=this.results_data[a],a.selected=!0,this.form_field.options[a.options_index].selected=!0,this.is_multiple?
this.choice_build(a):this.selected_item.getElement("span").set("text",a.text),this.results_hide(),this.search_field.set("value",""),this.form_field.fireEvent("change"),this.search_field_scale()},result_activate:function(a){a.addClass("active-result").setStyle("display","block")},result_deactivate:function(a){a.removeClass("active-result").setStyle("display","none")},result_deselect:function(a){var b;b=this.results_data[a];b.selected=!1;this.form_field.options[b.options_index].selected=!1;document.id(this.container_id+
"_o_"+a).removeClass("result-selected").addClass("active-result").setStyle("display","block");this.result_clear_highlight();this.winnow_results();this.form_field.fireEvent("change");this.search_field_scale()},results_search:function(){this.results_showing?this.winnow_results():this.results_show()},winnow_results:function(){var a,b,c,e,f,g,i,h,j;this.no_results_clear();f=0;g=this.search_field.get("value")===this.default_text?"":(new Element("div",{text:this.search_field.get("value").trim()})).get("html");
...
this.result_select();break;case "esc":this.results_showing&&this.results_hide();break;case "tab":case "up":case "down":case "shift":break;default:this.results_search()}},keydown_checker:function(a){this.search_field_scale();a.key!=="backspace"&&this.pending_backstroke&&this.clear_backstroke();switch(a.key){case "backspace":this.backstroke_length=this.search_field.value.length;break;case "tab":this.mouse_on_container=!1;break;case "enter":a.preventDefault();break;case "up":a.preventDefault();this.keyup_arrow();
break;case "down":this.keydown_arrow()}},search_field_scale:function(){var a,b;if(this.is_multiple)a={position:"absolute",visibility:"hidden"},b=this.search_field.getStyles("font-size","font-style","font-weight","font-family","line-height","text-transform","letter-spacing"),Object.merge(a,b),a=new Element("div",{styles:a}),a.set("text",this.search_field.get("value")),document.body.grab(a),b=a.getCoordinates().width+25,a.destroy(),b>this.f_width-10&&(b=this.f_width-10),this.search_field.setStyle("width",
